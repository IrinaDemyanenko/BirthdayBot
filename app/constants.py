from app.variables import current_year, formatted_time
...
what_i_can = (
    ...
    f'При создании или редактировании друга можно\n'
    f'включить напоминание о Дне Рождении за\n'
    f'неделю до события, чтобы успеть подготовиться\n'
    f'и купить подарок (время напоминания по умолчанию 12:00);\n'
